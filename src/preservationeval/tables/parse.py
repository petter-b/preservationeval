...
def fetch_and_validate_tables(
    ...
    try:
        ...
        pi_table: ShiftedArray = ShiftedArray(
            np.array(pi_array[: pi_info.size], dtype=np.int8).reshape(
        ...
        mold_table: ShiftedArray = ShiftedArray(
            np.array(pi_array[mold_info.array_offset :], dtype=np.int8).reshape(
        ...
        emc_table: ShiftedArray = ShiftedArray(
